...
export const stepsItems = [
  {
    ...
    description:
      "Submit your medical files through our secure online console. No formatting or sorting needed — we’ll take it from there.",
    number: "Step 1",
    iconPath:
  ...
  },
  {
    ...
    description:
      "Our intelligent system analyzes the case, identifies key injuries, timelines, ICD codes, and forecasts projected medical costs.",
    number: "Step 2",
    iconPath:
  ...
  {
    title: "Physician Verification & Signature",
    description:
      "A licensed doctor reviews the summary, verifies its accuracy, and signs off — delivering a final report ready for litigation or negotiation.",
    number: "Step 3",
    iconPath:

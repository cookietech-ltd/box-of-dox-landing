...
export const services2 = [
  {
    ...
    text: "We extract key events, treatments, and patterns from hundreds of pages — turning complex clinical language into timelines and plain-language summaries.",
    categories: [
  ...
  },
  {
    ...
    title: "Injury Causation Analysis",
    text: "Our physicians provide clear medical opinions linking diagnoses to the incident — backed by clinical findings, imaging, and standard of care.",
    categories: ["Accident Connection", "Mechanism of Injury", "Expert Medical Opinion"],
    delay: "0.15s",
  ...
  },
  {
    ...
    title: "Future Cost Projections",
    text: "We estimate 5 years of future medical needs based on real-world pricing and treatment pathways — including best-, mid-, and worst-case scenarios.",
    categories: [
      "Tiered Cost Estimates",
      "CPT-Based Pricing",
      "National UCR Benchmarking",
    ],
    delay: "0.3s",
  ...
  },
  {
    ...
    title: "Physician-Signed Reports",
    text: "Every report is reviewed and signed by a licensed physician to provide credibility and compliance in legal and settlement negotiations.",
    categories: ["Signature Verification", "Medical Authority", "Expert Compliance"],
    delay: "0.3s",
